...
A handoff restoration that can repeat only the exact next action but cannot explain the global fault evolution and long-term roadmap is considered incomplete.