...
public final class MainActivity extends Activity {
    ...
    private static boolean microOk(OutputSet r){return r!=null&&r.error.isEmpty()&&r.v.containsKey("y");}
